...
const calendarIntro = (day: string): SingleCard => [ {text: `${day}.`, size: "big"}, {text: "luukku"}]
const daysToChristmas =  (day: string): SingleCard => [{ text: `${daysLeft(day)}`, size: "big" }, { text: "päivää jouluun!" }];
